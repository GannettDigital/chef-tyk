...
# For documentation see https://tyk.io/v1.9/configuration/configuration/
default['tyk']['pump']['config']['listen_port'] = 8080
default['tyk']['pump']['config']['secret'] = 'Y0uSh0u1dR3a11yChang3Th1sS3cr3t'
default['tyk']['pump']['config']['template_path'] = "#{node['tyk']['pump']['install_path']}/templates"
default['tyk']['pump']['config']['tyk_js_path'] = "#{node['tyk']['pump']['install_path']}/js/tyk.js"
default['tyk']['pump']['config']['use_db_app_configs'] = true
default['tyk']['pump']['config']['app_path'] = "#{node['tyk']['pump']['install_path']}/apps"
default['tyk']['pump']['config']['middleware_path'] = "#{node['tyk']['pump']['install_path']}/middleware"
default['tyk']['pump']['config']['storage']
default['tyk']['pump']['config']['storage']['type'] = 'redis'
default['tyk']['pump']['config']['storage']['host'] = 'localhost'
default['tyk']['pump']['config']['storage']['port'] = 6379
default['tyk']['pump']['config']['storage']['username'] = ''
default['tyk']['pump']['config']['storage']['password'] = ''
default['tyk']['pump']['config']['storage']['database'] = 0
default['tyk']['pump']['config']['storage']['optimisation_max_idle'] = 500
default['tyk']['pump']['config']['enable_analytics'] = true
default['tyk']['pump']['config']['analytics_config']['type'] = 'mongo'
default['tyk']['pump']['config']['analytics_config']['mongo_url'] = 'mongodb://127.0.0.1:27017/tyk_analytics'
default['tyk']['pump']['config']['analytics_config']['mongo_collection'] = 'tyk_analytics'
default['tyk']['pump']['config']['analytics_config']['purge_delay'] = 5
default['tyk']['pump']['config']['analytics_config']['ignored_ips'] = []
default['tyk']['pump']['config']['health_check']['enable_health_checks'] = true
default['tyk']['pump']['config']['health_check']['health_check_value_timeouts'] = 60
default['tyk']['pump']['config']['optimisations_use_async_session_write'] = true
default['tyk']['pump']['config']['allow_master_keys'] = false
default['tyk']['pump']['config']['policies']['policy_source'] = 'mongo'
default['tyk']['pump']['config']['policies']['policy_record_name'] = 'tyk_policies'
default['tyk']['pump']['config']['hash_keys'] = true
default['tyk']['pump']['config']['suppress_redis_signal_reload'] = false
